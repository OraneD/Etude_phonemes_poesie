...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 19 15:23:36 2023
                            ...
                            if row[2] == "12":
                                ...
                                #for phoneme in liste_consonnes :
                                   # if len(re.findall(phoneme, row[1])) > 1 :
                                       # consonnes_rep += 1
                    names = [k for k in rep_voyelles.keys()]
                    values = [round(v / nb, 2) for v in rep_voyelles.values()]
                    print(rep_voyelles)
...
def histogramme(x, y, z, u) :
    ...
    plt.ylabel("Moyenne")
    plt.title("Moyenne des occurrences de voyelles par vers")
    ...
    with open("../../resultats/statistique/tableaux.txt", "a") as tab :
        tab.write("----- MOyenne des occurrences de voyelles par vers ----- \n \n")
