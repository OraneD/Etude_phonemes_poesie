...
def transcription_prose(fichier, output):
    ...
    with open(fichier, "r") as f:
        ...
        texte_propre = (
            re.sub(r"[^\.\?\!\w\s\'’-]", "", texte_remplacement_apostrophe)
            .lower()
            .strip("-")
            .strip("'")
        )
            ...
            with open("dico1.txt", "r") as dico:
                ...
                for ligne in lignes:
                    ...
                    if mot.strip() == entry:
                        ...
                        if (
                            len(liste_mots) > 1
                            and (mot[-1] == "s" or mot[-1] == "x")
                            and liste_mots[0][0] in voyelles
                        ):
...
transcription_prose(
    "../../Corpus/LaMartine/lamartine_destinees_utf8.txt",
